# Installation of AzureAD module: Install-Module AzureAD
...
function Search-Permissions {
    ...
    try {
        ...
        if ($ResultGroup.Members -contains $ResultUser) {
        ...
        Write-Host -ForegroundColor Red "Group $Group not found in domain $LocalDomain!"
        return $false
    }
}
